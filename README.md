...
# DevOps
![GitHub Workflow Status (branch)](https://img.shields.io/github/workflow/status/pliniomartos/devops/<action name taken from main.yml>/<branch>?style=flat-square)